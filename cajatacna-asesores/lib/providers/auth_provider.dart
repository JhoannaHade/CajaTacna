...
class AuthProvider extends ChangeNotifier {
  ...
  /// Registro de Asesor: crea usuario en Auth + perfil en DB con es_asesor = true.
  Future<bool> registerAdvisorAccount({
    required String nombre,
    required String email,
    required String password,
    required String tipoDocumento,
    ...
    try {
      ...
      if (perfilRes.statusCode != 200 && perfilRes.statusCode != 201) {
        throw Exception('Error al crear el perfil de asesor. Intenta de nuevo.');
      }

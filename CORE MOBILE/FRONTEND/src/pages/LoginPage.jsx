...
import {
  ...
  Mail, Lock, LogIn, ChevronLeft, ChevronRight,
} from 'lucide-react'
...
// Carrusel "Nuestra esencia" — identidad de Banco BCP.
const SLIDES = [
  {
    tag: 'NUESTRA ESENCIA',
    icon: Target,
  ...
  },
  {
    ...
    icon: Eye,
    titulo: 'Visión',
    desc: 'Ser la caja aliada de las familias y microempresas peruanas, reconocida por su cercanía, tecnología y compromiso con el crecimiento de cada cliente.',
  ...
  return (
    <div className="cm-login">
      ...
      <div className="cm-login-topbar">
        <Logo size={40} variant="dark" subtitle="PORTAL DE ASESORES" />
        <span className="cm-login-chip">Sistema interno · Uso exclusivo de Asesores Caja Tacna</span>
      </div>
      ...
      <section className="cm-auth">
        ...
        <div className="cm-auth-inner">
          ...
          <h2>Inicia sesión</h2>
          <p className="cm-auth-lead">Acceso del personal · ingresa con tu correo corporativo Caja Tacna.</p>
            ...
            <div className="cm-field">
              ...
              <div className="cm-input-wrap">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="ejemplo@cajatacna.com.pe"
                  autoComplete="email"
                  value={email}
          ...
          <p className="cm-auth-hint">
            Demo Asesor Caja Tacna · Correo <strong>asesor@cajatacna.com.pe</strong> · Clave <strong>123456</strong>
          </p>
        </div>
      </section>
    </div>
